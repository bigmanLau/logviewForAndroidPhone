...
public abstract class StandOutWindow extends Service {
	...
	public static void show(Context context,
							Class<? extends StandOutWindow> cls, int id, String packageName) {
		context.startService(getShowIntent(context, cls, id,packageName));
	}
	 ...
	 */
	public Intent getPersistentNotificationIntent(int id,String packageName) {
		return null;
	}
	...
	public Notification getPersistentNotification(int id) {
		...
		// a bigger id
		Intent notificationIntent = getPersistentNotificationIntent(id,packageName);
